  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <main className="flex-1">
              ...
              <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 lg:gap-20">
                <div className="w-full md:w-5/12 lg:w-1/2 order-2 md:order-1">
                  ...
                  <p className="text-base md:text-lg lg:text-xl text-slate-600 mb-6 md:mb-8">
                    Combino conocimiento científico con un profundo entendimiento de la
                ...
                <div className="w-full md:w-7/12 lg:w-1/2 order-1 md:order-2 mb-8 md:mb-0">
                  <div className="relative">
                    ...
                    <div className="relative z-10 rounded-2xl md:rounded-3xl overflow-hidden shadow-xl md:shadow-2xl border-2 md:border-4 border-white aspect-[3/4] max-w-xs md:max-w-md mx-auto">
                      <Image
                        src="/assets/images/about-us/Gerardo-Castillo.JPG"
                        fill
        ...
        {/* Bio Section - Diseño Mejorado */}
        <section className="py-16 md:py-24 bg-gradient-to-b from-white to-blue-50 relative overflow-hidden">
          {/* Elementos decorativos de fondo */}
          <div className="absolute top-10 left-10 w-64 h-64 bg-blue-50 rounded-full blur-3xl opacity-70 z-0" />
          <div className="absolute bottom-10 right-10 w-96 h-96 bg-blue-100/30 rounded-full blur-3xl opacity-50 z-0" />
          
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-12 md:mb-16">
                <div className="inline-flex items-center justify-center px-4 py-1.5 mb-4 text-xs font-medium text-blue-700 bg-blue-100 rounded-full shadow-sm">
                  <BookOpen className="w-3.5 h-3.5 mr-1.5" />
                  <span>Mi Biografía</span>
                </div>
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight mb-6 text-blue-900 bg-gradient-to-r from-blue-800 to-blue-600 bg-clip-text text-transparent">
                  Mi perfil
                </h2>
                <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-blue-300 mx-auto rounded-full mb-6" />
              </div>
                ...
                <div className="md:col-span-12">
                  <div className="space-y-6 md:space-y-8 text-slate-700">
                    <p className="text-lg md:text-xl font-medium leading-relaxed">
                      ...
                      de tratamiento naturales y efectivas para sus pacientes.
                    </p>
                    
                    <div className="pl-4 border-l-4 border-blue-200 py-1">
                      <p className="text-base md:text-lg leading-relaxed">
                        Su pasión por la homeopatía comenzó durante sus estudios de
                    ...
                    <div className="flex flex-col md:flex-row md:items-center gap-4 p-4 md:p-6 bg-white rounded-xl shadow-sm border border-blue-50">
                      <div className="flex-shrink-0 p-3 bg-blue-50 rounded-full">
                        <Heart className="h-6 w-6 text-blue-600" />
                      </div>
                      <p className="text-base md:text-lg italic">
                        &quot;Creo firmemente en la importancia de una relación médico-paciente basada en la confianza y el respeto mutuo.&quot;
                      </p>
                    </div>

                    <p className="text-base md:text-lg leading-relaxed">
                      Dedica tiempo a escuchar atentamente las preocupaciones
              ...
              <div className="mt-12 md:mt-16 flex flex-wrap justify-center gap-3 md:gap-4">
                {['Homeopatía', 'Medicina Natural', 'Tratamientos Integrales', 'Bienestar'].map((tag, index) => (
                  <span key={index} className="px-4 py-2 bg-blue-50 text-blue-700 rounded-full text-sm font-medium shadow-sm">
                    {tag}
                  </span>
                ))}
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-8 md:mb-16">
                ...
                <p className="text-base md:text-lg text-slate-600 max-w-3xl mx-auto">
                  Cuento con instalaciones modernas y cómodas, diseñadas para
              ...
              <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
                ...
                <div>
                  ...
                  <p className="text-sm md:text-base text-slate-600 mb-4 md:mb-6">
                    Mi consultorio está ubicado en una zona céntrica y de
            ...
            <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8 text-center md:text-left">
              <div className="w-full md:w-2/3">
                ...
                <p className="text-blue-100 text-sm md:text-lg">
                  ...
                  beneficios de mi enfoque homeopático personalizado.
                </p>
              </div>
